...
public class LocationLPNValidatorForOutbound {
     ...
     */
    public void validate(final List<LocationLPN> locationLPNList, final Integer orderQuantity) {
        ...
        final int availableInventoryQuantityForOutbound = calculateAvailableInventoryQuantity(locationLPNList);
